...
## Middleman and GitHub
Our software is stored on <b>github</b> and we use GitHub Pages for publishing our blog.  It's kinda geeky and we're looking for a more simple publishing platform.

<a href="http://github.com">GitHub</a> is fantastic and <a href="http://middlemanapp.com/">Middleman</a> is a decent way to publish a simple blog like this.  Decent, but not great.  We're also interested in ideas for improvement.
